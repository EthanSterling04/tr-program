...
static void test_expand_charseq(void)
{
    ...
    check_expand( "a-eA-E", "abcdeABCDE" );
    check_expand( "A-Ea-e", "ABCDEabcde" );
    check_expand( "a-cx-z", "abcxyz" );
    check_expand( "\\n", "\n" );
...
static void test_translate_char(void)
{
    ...
    CHECK_CHAR( translate_char('h', "hH", "Hh"), 'H' );
    CHECK_CHAR( translate_char('b', "abcABCabc", "ABCabcABC"), 'B' );
    CHECK_CHAR( translate_char('d', "ddd", "xyz"), 'x' );
